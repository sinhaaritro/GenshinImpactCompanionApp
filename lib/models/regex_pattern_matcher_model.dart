class RegKeywordsTags {
  static const String headingTags =
      r"\bNormal Attack|\bCharged Attack|\bHold:|\bElemental Absorption:|\bCook|DEF|\bDMG";
  static const String inParagraphTags = r"\bDEF|\bDMG";
  static const String officialWebsiteDescription =
      r"\bDescription from Official Website";
